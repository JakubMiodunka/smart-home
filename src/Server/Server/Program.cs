...
const string ConnectionString = "Server=127.0.0.1;Database=smart_home;User Id=app_user;Password=1234; Encrypt=True; TrustServerCertificate=True"; // TODO: Provide connection string to SQL server instance here.
