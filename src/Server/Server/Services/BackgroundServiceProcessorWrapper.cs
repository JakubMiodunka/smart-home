...
/// </summary>
public sealed class BackgroundServiceProcessorWrapper : BackgroundService
{
    #region Properties
    private readonly IBackgroundServiceProcessor _processor;
    private readonly TimeSpan _serviceExecutionInterval;
    private readonly ILogger<BackgroundServiceProcessorWrapper> _logger;
    #endregion

    #region Instantiation
    /// <summary>
    /// Creates new instance of <see cref="BackgroundServiceProcessorWrapper"/>.
    /// </summary>
    ...
    /// </exception>
    public BackgroundServiceProcessorWrapper(
        IBackgroundServiceProcessor processor,
        TimeSpan serviceExecutionInterval,
        ILogger<BackgroundServiceProcessorWrapper> logger)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        using var serviceIntervalTimer = new PeriodicTimer(_serviceExecutionInterval);
